...
dataBefore = '~/machine_learning/repos/GRU4REC-pytorch/data/raw-data/yoochoose-clicks.dat' #Path to Original Training Dataset "Clicks" File
dataTestBefore = '~/machine_learning/repos/GRU4REC-pytorch/data/raw-data/yoochoose-test.dat' #Path to Original Testing Dataset "Clicks" File
dataAfter = '~/machine_learning/repos/GRU4REC-pytorch/data/preprocessed-data/' #Path to Processed Dataset Folder
